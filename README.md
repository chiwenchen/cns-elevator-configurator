...
台灣電梯製造商內部業務工具。業務輸入坑道規格或需求條件，系統自動生成合規電梯設計圖 (DXF) 並提供 AI 設計指引助理。手機版完整支援，業務在外面也能快速生圖。

**線上版**: [vera-plot.redarch.dev](https://vera-plot.redarch.dev)
...
業務在外面用手機也能完整操作：
- **底部 Tab Bar**: 參數 / 圖紙 / AI / 圖紙庫，一鍵切換
- **圖紙預覽**: 左右滑動切換平面圖和側面圖，雙指縮放
- **原生分享**: 下載 DXF 時呼叫手機原生分享面板
- **自動切換**: 輸入參數後自動跳到圖紙預覽
- **平板適配**: 768px-1060px 自動切換為兩欄佈局
